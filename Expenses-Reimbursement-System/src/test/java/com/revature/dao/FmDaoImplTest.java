...
public class FmDaoImplTest  {
    ...
    public void testGetAllReId() {
        ...
        Mockito.when(fmDao.getAllReId(5)).thenReturn(expectedResult);
        List<Reimbursement> actualResult = fmDao.getAllReId(5);

        assertEquals(expectedResult,actualResult);
    }

    @Test
    public void testGetAllRe() {
        Integer id=7;
        ...
        Mockito.when(fmDao.getAllRe()).thenReturn(expectedResult);
        List<Reimbursement> actualResult = fmDao.getAllRe();
    ...
    public void testUpdateReim() {
        ...
        fmDao.updateReim(uDate1);
        Mockito.verify(fmDao,Mockito.times(1)).updateReim(uDate1);

        fmDao.updateReim(uDate2);
        Mockito.verify(fmDao,Mockito.times(1)).updateReim(uDate2);
